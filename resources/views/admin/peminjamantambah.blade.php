        ...
        <div class="card">
            <form class="form-horizontal" method="post" action="{{ $aksi }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 text-end control-label col-form-label">Banyak Buku</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="jumlah" placeholder="Masukan Jumlah Buku yang dipinjam" required value="{{ isset($data) ? $data->jumlah : '' }}" />
                        </div>
                    </div>
                </div>
