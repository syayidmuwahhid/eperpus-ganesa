            ...
            <form class="form-horizontal" method="post" action="{{ $aksi }}">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="name" placeholder="Masukan Nama Anggota" required value="{{ isset($data) ? $data->name : '' }}" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 text-end control-label col-form-label">Nomor Keanggotaan</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nomor_anggota" placeholder="Masukan Nomor Keanggotaan" required value="{{ isset($data) ? $data->nomor_anggota : '' }}" />
                        </div>
                    </div>
                    <!-- <div class="form-group row">
